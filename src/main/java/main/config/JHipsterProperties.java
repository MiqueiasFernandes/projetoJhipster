...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "projetoJhipster@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "projetoJhipster API";

        private String description = "projetoJhipster API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "projetoJhipster";
